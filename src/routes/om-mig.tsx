  ...
  head: () => ({
    meta: [
      { title: "Om mig – Lins & Lager" },
      {
        name: "description",
        content:
          "Lär känna verkstaden bakom Lins & Lager: handgjorda personliga presenter med gravyr, 3D-utskrift och foto – tillverkade i Småland sedan 2016.",
      },
...
const workflow = [
  ...
  },
  {
    ...
    text: "Allt tillverkas för hand i mitt lager i Småland – inga halvfabrikat, ingen stress.",
  },
  {
    icon: Gift,
    title: "Presentklart",
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-14">
      ...
      <div className="mt-8 grid items-center gap-12 md:grid-cols-2">
        <div>
          <p className="font-script text-3xl text-primary">hej, och välkommen in!</p>
          ...
          <p className="mt-7 max-w-md text-lg text-muted-foreground">
            Det började med kameran. Jag fotograferade bröllop och dop – och märkte att det fina
            minnet ofta hamnade i en låda. Jag ville göra minnen som går att hålla i, varje dag.
          </p>
          ...
          <p className="mt-4 max-w-md text-lg text-muted-foreground">
            Varje beställning tillverkas för hand när den kommer in. Därför tar jag in ett
            begränsat antal per vecka – kvalitet går alltid före kvantitet.
          </p>
      ...
      <section className="mt-20">
        <p className="font-script text-2xl text-primary">så jobbar jag</p>
        <h2 className="mt-1 font-serif text-4xl font-black tracking-tight">Från idé till present</h2>
